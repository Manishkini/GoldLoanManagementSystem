...
session_start();
	...
	if (isset($_POST["submit"])) {
		if (isset($_POST["name"]) && !empty($_POST["name"])) {
			...
			if (isset($_SESSION['name']) && isset($_SESSION['sname']) && isset($_SESSION['area']) && isset($_SESSION['email']) && isset($_SESSION['pass']) && isset($_SESSION['gender']) && isset($_SESSION['da']) && isset($_SESSION['ta']) && isset($_SESSION['bsal']) && isset($_SESSION['role']) && isset($_SESSION['ecode']) && isset($_SESSION['phonen'])) {
				...
				$sql = "INSERT INTO `employee`(`id`, `name`, `surname`, `phone`, `gender`, `workarea`, `email`, `role`, `basicsalary`, `da`, `ta`, `totalsalary`, `password`) VALUES ('$ecode','$name','$sname','$phonen','$gender','$area','$email','$role','$bsal','$da','$ta','$tsal','$pass')";
